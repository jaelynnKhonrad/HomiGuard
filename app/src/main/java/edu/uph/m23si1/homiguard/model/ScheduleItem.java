...
public class ScheduleItem {
    ...
    // NOTE: parameter names kept explicit to avoid confusion
    ...
    // Primary getters/setters (original names)
    ...
    // --- Compatibility helpers used by LightingActivity ---
    // LightingActivity expects getKey() and getRoom() — map them to id/deviceName
    public String getKey() { return id; }
    public void setKey(String key) { this.id = key; }

    public String getRoom() { return deviceName; }
    public void setRoom(String room) { this.deviceName = room; }
}
