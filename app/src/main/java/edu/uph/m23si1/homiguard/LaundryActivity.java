...
public class LaundryActivity extends AppCompatActivity {
    ...
    final String ROOM_NAME = "Laundry";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchLaundry.setOnCheckedChangeListener((btn, isChecked) -> {
        ...
        // ---------------------------------------------------
        // SCHEDULE EXECUTOR (cek tiap detik)
        // ---------------------------------------------------
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (String date : dates) {
                            String header;
                            if (date.equals(todayStr)) header = "Today";
                            else if (date.equals(yesterdayStr)) header = "Yesterday";
                            else header = date;
    ...
    private void setupFormEvents() {
        ...
        rbEveryday.setOnCheckedChangeListener((btn, isChecked) -> {
            if (isChecked) {
        ...
        rbOnce.setOnCheckedChangeListener((btn, isChecked) -> {
            if (isChecked) {
    ...
    private void loadScheduleData() {
        scheduleRef.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(LaundryActivity.this, "Failed loading schedule", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void executeSchedule() {
        ...
        scheduleRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String dayText = new SimpleDateFormat("EEE", Locale.getDefault())
                        .format(Calendar.getInstance().getTime());
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (!ROOM_NAME.equals(item.getDeviceName())) continue;

                    boolean dateMatch =
                            item.getDate().equals("Everyday") || item.getDate().equals(today);

                    if (!dateMatch) continue;

                    if (now.equals(item.getOnTime())) deviceRef.setValue(true);
                    if (now.equals(item.getOffTime())) deviceRef.setValue(false);
                }
            }
    ...
    private void showTimePicker(TimeListener listener) {
        ...
        TimePickerDialog dialog = new TimePickerDialog(
                this,
                (view, hour, minute) -> listener.onTimeSelected(hour, minute),
    ...
    private void pickDate() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(
                ...
                (view, year, month, day) -> {
                    ...
                    String display = new SimpleDateFormat("EEE, dd MMM yyyy",
